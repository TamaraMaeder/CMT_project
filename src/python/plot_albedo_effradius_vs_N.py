...
ln1 = ax1.plot(
    ...
    color='#1f77b4', marker='o', linewidth=1.8, markersize=5,
    label='Albedo (–)'
)
ax1.set_xlabel('Sulfate concentration $N$ [cm$^{-3}$]')
ax1.set_ylabel('Albedo (–)', color='#1f77b4')
...
ln2 = ax2.plot(
    ...
    color='#d62728', marker='s', linewidth=1.8, markersize=4,
    label='Effective radius [m]'
)
ax2.set_ylabel('Effective radius $r_\\mathrm{eff}$ [m]', color='#d62728')
...
png_path = RESULTS_DIR / 'albedo_and_effective_radius_vs_sulfate_concentration.png'
