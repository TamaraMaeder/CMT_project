 ...
 *   ./bin/albedo_run
 *
 * If you run the binary from another directory, adjust DATA_DIR below accordingly.
 */
...
/* If you have a header (albedo_fn.h), include it instead of the extern line. */
// #include "albedo_fn.h"
extern double albedo_from_two_aerosol_csvs(const char *csv_aerosol_one,
                                           const char *csv_aerosol_two);

/* Change this if your execution directory differs from the project root. */
#ifndef DATA_DIR
...
int main(void) {
    ...
    const Scenario scenarios[] = {
        {
            "Scenario 1: Sulfate accum 3.0e+02 cm3",
            "Sea_salt_coarse_profile_for_Sulfate_accum_and_Sea_salt_coarse_simulation.csv",
            "profile_sulfate_seasalt_N_for_3.0e+02_cm3.csv"
        },
        {
            "Scenario 2: Sulfate accum 4.0e+02 cm3",
            "Sea_salt_coarse_profile_for_Sulfate_accum_and_Sea_salt_coarse_simulation.csv",
            "profile_sulfate_seasalt_N_for_4.0e+02_cm3.csv"
        },
        {
            "Scenario 3: Sulfate accum 5.0e+02 cm3",
            "Sea_salt_coarse_profile_for_Sulfate_accum_and_Sea_salt_coarse_simulation.csv",
            "profile_sulfate_seasalt_N_for_5.0e+02_cm3.csv"
        },
        {
            "Scenario 4: Sulfate accum 6.0e+02 cm3",
            "Sea_salt_coarse_profile_for_Sulfate_accum_and_Sea_salt_coarse_simulation.csv",
            "profile_sulfate_seasalt_N_for_6.0e+02_cm3.csv"
        },
        {
            "Scenario 5: Sulfate accum 7.0e+02 cm3",
            "Sea_salt_coarse_profile_for_Sulfate_accum_and_Sea_salt_coarse_simulation.csv",
            "profile_sulfate_seasalt_N_for_7.0e+02_cm3.csv"
        },
        {
            "Scenario 6: Sulfate accum 8.0e+02 cm3",
            "Sea_salt_coarse_profile_for_Sulfate_accum_and_Sea_salt_coarse_simulation.csv",
            "profile_sulfate_seasalt_N_for_8.0e+02_cm3.csv"
        },
        {
            "Scenario 7: Sulfate accum 9.0e+02 cm3",
            "Sea_salt_coarse_profile_for_Sulfate_accum_and_Sea_salt_coarse_simulation.csv",
            "profile_sulfate_seasalt_N_for_9.0e+02_cm3.csv"
        },
        {
            "Scenario 8: Sulfate accum 1.0e+03 cm3",
            "Sea_salt_coarse_profile_for_Sulfate_accum_and_Sea_salt_coarse_simulation.csv",
            "profile_sulfate_seasalt_N_for_1.0e+03_cm3.csv"
        }
    ...
    char out_path[512];
    if (path_join(out_path, sizeof(out_path), DATA_DIR, "albedo_vs_N.csv") != 0) {
    ...
    for (size_t i = 0; i < N; ++i) {
        ...
        /* Optional pre-check for clearer messages */
